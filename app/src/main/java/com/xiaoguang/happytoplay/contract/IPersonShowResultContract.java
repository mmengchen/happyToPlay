...
public interface IPersonShowResultContract {
    interface IPersonShowResultView extends IBaseView<IPersonShowResultPresenter> {
        /**
         *  Toast形式提示
         */
    ...
    interface IPersonShowResultPresenter extends  IBasePresenter{
        /**
         * 加载数据
         * @param o
         */
